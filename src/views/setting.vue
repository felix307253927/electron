  ...
  <div class="setting">
    <el-form :model="formData" :rules="rules" label-width="100px">
      <el-form-item label="服务器地址:" prop="host">
        <el-input type="text" placeholder="例如: http://enasr.edu.hivoice.cn" v-model.trim="formData.host" auto-complete="off"></el-input>
      </el-form-item>
      <el-form-item label="服务器端口:" prop="port">
        <el-input type="number" placeholder="默认80或443" v-model.trim.number="formData.port" auto-complete="off"></el-input>
      </el-form-item>
      <el-form-item label="mp3服务地址:" prop="mp3host">
        <el-input type="text" placeholder="例如: http://enasr.edu.hivoice.cn" v-model.trim="formData.mp3host" auto-complete="off"></el-input>
      </el-form-item>
      <el-form-item label="mp3服务端口:" prop="mp3port">
        <el-input type="number" placeholder="默认80或443" v-model.trim.number="formData.mp3port" auto-complete="off"></el-input>
      </el-form-item>
